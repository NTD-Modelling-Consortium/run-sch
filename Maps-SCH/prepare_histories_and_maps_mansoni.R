...
# Combine 2023 maps
mansoni_g1_2023 = read.csv("G1.mansoni_2023.csv") 
mansoni_g2_2023 = read.csv("G2.mansoni_2023.csv") 
mansoni_g3_2023 = read.csv("G3.mansoni_2023.csv")[,1:1003] 
mansoni_g4_2023 = read.csv("G4_mansoni_2023.csv")[,1:1003]  
mansoni_g5_2023 = read.csv("G5.mansoni_2023.csv") 
mansoni_g6_2023 = read.csv("G6.mansoni.2023.csv")[,1:1003] 
...
# Combine 2005 maps
mansoni_g1_2005 = read.csv("G1.mansoni_2005.csv") 
mansoni_g2_2005 = read.csv("G2.mansoni_2005.csv") 
mansoni_g3_2005 = read.csv("G3.mansoni_2005.csv")[,1:1003] 
mansoni_g4_2005 = read.csv("G4_mansoni_2005.csv")[,1:1003]  
mansoni_g5_2005 = read.csv("G5.mansoni_2005.csv") 
mansoni_g6_2005 = read.csv("G6.mansoni_2005.csv")[,1:1003] 
...
# Combine 2013 maps
mansoni_g1_2013 = read.csv("G1.mansoni_2013.csv") 
mansoni_g2_2013 = read.csv("G2.mansoni_2013.csv") 
mansoni_g3_2013 = read.csv("G3.mansoni_2013.csv")[,1:1003] 
mansoni_g4_2013 = read.csv("G4_mansoni_2013.csv")[,1:1003]  
mansoni_g5_2013 = read.csv("G5.mansoni_2013.csv") 
mansoni_g6_2013 = read.csv("G6.mansoni_2013.csv")[,1:1003] 
...
save(iu_task_lookup, file="iu_task_lookup_mansoni_high_burden.rds")
save(iu_task_lookup, file="iu_task_lookup_mansoni_low_burden.rds")
...
save(mansoni_maps, file="mansoni_maps.rds")
...
for (id in 1:max(iu_task_lookup$TaskID)){
  ...
  for (iu in ius[1]) {
    ...
    mda_path<-file.path(inputs_path,paste0("InputMDA_MTP_",id,".xlsx"))
