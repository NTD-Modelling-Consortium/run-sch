...
# Load task IDs
load("iu_task_lookup_trichuris.rds")
...
save(proj_iu_task_lookup, file="proj_iu_task_lookup_trichuris.rds")
...
write.csv(table_iu_idx, file = paste0("table_iu_idx_trichuris.csv"), row.names = F)
