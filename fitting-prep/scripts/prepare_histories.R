...
save(iu_task_lookup, file=file.path(kPathToMapsArtefacts, "iu_task_lookup_sth.rds"))
...
write.csv(sth_distributions,file=file.path(kPathToMapsArtefacts, "sartorious_2021_withTaskID.csv"), row.names = F)  
