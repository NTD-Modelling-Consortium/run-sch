...
# Combine 2023 maps
mansoni_g1_2023 = read.csv(file.path(kPathToMapsSCH, "G1.mansoni_2023.csv")) 
mansoni_g2_2023 = read.csv(file.path(kPathToMapsSCH, "G2.mansoni_2023.csv")) 
mansoni_g3_2023 = read.csv(file.path(kPathToMapsSCH, "G3.mansoni_2023.csv"))[,1:1003] 
mansoni_g4_2023 = read.csv(file.path(kPathToMapsSCH, "G4_mansoni_2023.csv"))[,1:1003]  
mansoni_g5_2023 = read.csv(file.path(kPathToMapsSCH, "G5.mansoni_2023.csv")) 
mansoni_g6_2023 = read.csv(file.path(kPathToMapsSCH, "G6.mansoni.2023.csv"))[,1:1003] 
colnames(mansoni_g1_2023) = colnames(mansoni_g6_2023)
colnames(mansoni_g2_2023) = colnames(mansoni_g6_2023)
colnames(mansoni_g3_2023) = colnames(mansoni_g6_2023)
colnames(mansoni_g4_2023) = colnames(mansoni_g6_2023)
colnames(mansoni_g5_2023) = colnames(mansoni_g6_2023)

# rename 2023 to 2022 because only MDA history up to 2022 was used
mansoni_2022 = rbind(mansoni_g1_2023,
                         mansoni_g2_2023,
                         mansoni_g3_2023,
                         mansoni_g4_2023,
                         mansoni_g5_2023,
...
mansoni_2022 = mansoni_2022[,3:ncol(mansoni_2022)]
colnames(mansoni_2022) = c("IU_ID",sprintf("X%s",1:1000))
mansoni_2022 =  mansoni_2022 %>%
  filter((!is.na(X1)) & (!is.nan(X1))) %>% 
  mutate_all(as.numeric) %>%
  mutate_at(vars(starts_with("X")), ~ ifelse(. > 0.99, NA, .))

# Combine 2005 maps
mansoni_g1_2005 = read.csv(file.path(kPathToMapsSCH, "G1.mansoni_2005.csv")) 
mansoni_g2_2005 = read.csv(file.path(kPathToMapsSCH, "G2.mansoni_2005.csv")) 
mansoni_g3_2005 = read.csv(file.path(kPathToMapsSCH, "G3.mansoni_2005.csv"))[,1:1003] 
mansoni_g4_2005 = read.csv(file.path(kPathToMapsSCH, "G4_mansoni_2005.csv"))[,1:1003]  
mansoni_g5_2005 = read.csv(file.path(kPathToMapsSCH, "G5.mansoni_2005.csv")) 
mansoni_g6_2005 = read.csv(file.path(kPathToMapsSCH, "G6.mansoni_2005.csv"))[,1:1003] 
colnames(mansoni_g1_2005) = colnames(mansoni_g6_2005)
colnames(mansoni_g2_2005) = colnames(mansoni_g6_2005)
colnames(mansoni_g3_2005) = colnames(mansoni_g6_2005)
colnames(mansoni_g4_2005) = colnames(mansoni_g6_2005)
colnames(mansoni_g5_2005) = colnames(mansoni_g6_2005)


# rename 2005 to 2003 as this was when the first MDA intervention occurred
mansoni_2002 = rbind(mansoni_g1_2005,
                         mansoni_g2_2005,
                         mansoni_g3_2005,
                         mansoni_g4_2005,
                         mansoni_g5_2005,
                         mansoni_g6_2005)
mansoni_2002 = mansoni_2002[,3:ncol(mansoni_2002)]
colnames(mansoni_2002) = c("IU_ID",sprintf("X%s",1:1000))
mansoni_2002 =  mansoni_2002 %>%
  filter((!is.na(X1)) & (!is.nan(X1))) %>% 
  mutate_all(as.numeric) 
mansoni_2002 = left_join(mansoni_2022 %>% select(IU_ID),mansoni_2002) %>%
  mutate_at(vars(starts_with("X")), ~ ifelse(. > 0.99, NA, .))


# Combine 2013 maps
mansoni_g1_2013 = read.csv(file.path(kPathToMapsSCH, "G1.mansoni_2013.csv")) 
mansoni_g2_2013 = read.csv(file.path(kPathToMapsSCH, "G2.mansoni_2013.csv")) 
mansoni_g3_2013 = read.csv(file.path(kPathToMapsSCH, "G3.mansoni_2013.csv"))[,1:1003] 
mansoni_g4_2013 = read.csv(file.path(kPathToMapsSCH, "G4_mansoni_2013.csv"))[,1:1003]  
mansoni_g5_2013 = read.csv(file.path(kPathToMapsSCH, "G5.mansoni_2013.csv")) 
mansoni_g6_2013 = read.csv(file.path(kPathToMapsSCH, "G6.mansoni_2013.csv"))[,1:1003] 
colnames(mansoni_g1_2013) = colnames(mansoni_g6_2013)
colnames(mansoni_g2_2013) = colnames(mansoni_g6_2013)
colnames(mansoni_g3_2013) = colnames(mansoni_g6_2013)
colnames(mansoni_g4_2013) = colnames(mansoni_g6_2013)
colnames(mansoni_g5_2013) = colnames(mansoni_g6_2013)

mansoni_2013 = rbind(mansoni_g1_2013,
                         mansoni_g2_2013,
                         mansoni_g3_2013,
                         mansoni_g4_2013,
                         mansoni_g5_2013,
...
mansoni_2013 = mansoni_2013[,3:ncol(mansoni_2013)]
colnames(mansoni_2013) = c("IU_ID",sprintf("X%s",1:1000))
mansoni_2013 =  mansoni_2013 %>%
  filter((!is.na(X1)) & (!is.nan(X1))) %>% 
  mutate_all(as.numeric) 
mansoni_2013 = left_join(mansoni_2022 %>% select(IU_ID),mansoni_2013) %>%
  mutate_at(vars(starts_with("X")), ~ ifelse(. > 0.99, NA, .))
...
sch_histories = sch_histories_raw %>%
  filter(IU_ID_MAPPING %in% mansoni_2002$IU_ID)  %>%
...
add_burnin_year = data.frame(IU_ID_MAPPING = mansoni_2002$IU_ID,
                        Year = 1985,
                        TargetPop = "Adults",
...
histories_joined_full = data.frame(IU_ID_MAPPING = rep(mansoni_2002$IU_ID,each=41),
                              Year = rep(c(1985,rep(2003:2022,each=2)), length(mansoni_2002$IU_ID)),
                              TargetPop = rep(c("Adults",rep(c("SAC", "Adults"),20)),length(mansoni_2002$IU_ID))) %>%
  mutate(Year_TargetPop = paste0(Year,"_",TargetPop)) %>% 
...
all_treatments = data.frame(IU=mansoni_2002$IU_ID) %>%
...
iu_no_mda = unique((histories_joined_full %>% 
                      filter(IU_ID_MAPPING %in% (iu_task_lookup %>% 
                                                   filter(TaskID == id_no_mda))$IU_ID))$IU_ID_MAPPING)
...
iu_summaries_2002 = data.frame(IU_ID = mansoni_2002$IU_ID,
                               mean = apply(mansoni_2002[,2:ncol(mansoni_2002)], 1, mean, na.rm=T),
                               sd = apply(mansoni_2002[,2:ncol(mansoni_2002)], 1, sd, na.rm=T),
                               min = apply(mansoni_2002[,2:ncol(mansoni_2002)], 1, min, na.rm=T),
                               max = apply(mansoni_2002[,2:ncol(mansoni_2002)], 1, max, na.rm=T)) 

iu_summaries_2013 = data.frame(IU_ID = mansoni_2013$IU_ID,
                               mean = apply(mansoni_2013[,2:ncol(mansoni_2013)], 1, mean, na.rm=T),
                               sd = apply(mansoni_2013[,2:ncol(mansoni_2013)], 1, sd, na.rm=T),
                               min = apply(mansoni_2013[,2:ncol(mansoni_2013)], 1, min, na.rm=T),
                               max = apply(mansoni_2013[,2:ncol(mansoni_2013)], 1, max, na.rm=T)) 

iu_summaries_2022 = data.frame(IU_ID = mansoni_2022$IU_ID,
                               mean = apply(mansoni_2022[,2:ncol(mansoni_2022)], 1, mean, na.rm=T),
                               sd = apply(mansoni_2022[,2:ncol(mansoni_2022)], 1, sd, na.rm=T),
                               min = apply(mansoni_2022[,2:ncol(mansoni_2022)], 1, min, na.rm=T),
                               max = apply(mansoni_2022[,2:ncol(mansoni_2022)], 1, max, na.rm=T))
...
save(iu_task_lookup, file=file.path(kPathToMapsArtefacts, "iu_task_lookup_mansoni_high_burden.rds"))
save(iu_task_lookup, file=file.path(kPathToMapsArtefacts, "iu_task_lookup_mansoni_low_burden.rds"))

# save batch IDs to maps file
mansoni_maps = list(list(data = iu_task_lookup %>% left_join(mansoni_2002, by=c("IU_ID"))),
                        list(data = iu_task_lookup %>% left_join(mansoni_2013, by=c("IU_ID"))),
                        list(data = iu_task_lookup %>% left_join(mansoni_2022, by=c("IU_ID"))))
save(mansoni_maps, file=file.path(kPathToMapsArtefacts, "mansoni_maps.rds"))
...
cat("Finished running prepare_histories_and_maps_mansoni.R \n")
