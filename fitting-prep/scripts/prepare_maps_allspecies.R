...
sth_distributions = read.csv(file.path(kPathToMapsArtefacts, "sartorious_2021_withTaskID.csv")) %>%
...
save(hookworm_map_allyears,file=file.path(kPathToMapsArtefacts, "hookworm_maps.rds"))
...
save(ascaris_map_allyears,file=file.path(kPathToMapsArtefacts, "ascaris_maps.rds"))
...
sth_distributions_tri = read.csv(file.path(kPathToMapsArtefacts, "sartorious_2021_withTaskID_trichuris.csv")) %>%
...
save(trichuris_map_allyears,file=file.path(kPathToMapsArtefacts, "trichuris_maps.rds"))
