...
def run_fitting_prep_sch(species_list, for_projections=False):
    ...
    if not for_projections:
        ...
        if SCHSpecies.HAEMATOBIUM in species_list or SCHSpecies.ALL in species_list:
            commands.append(("Rscript prepare_histories_and_maps_haematobium.R", "Preparing histories and maps for haematobium"))
        
        if SCHSpecies.MANSONI_HIGH in species_list or SCHSpecies.MANSONI_LOW in species_list or SCHSpecies.ALL in species_list:
            commands.append(("Rscript prepare_histories_and_maps_mansoni.R", "Preparing histories and maps for mansoni"))
...
"""
    ...
    if stage == Stage.FITTING_PREP:
        ...
        if sch_species:
            ...
            success = success and run_fitting_prep_sch(sch_species, args.for_projections)
        ...
        print("Fitting stage not yet implemented")
        sys.exit(1)
